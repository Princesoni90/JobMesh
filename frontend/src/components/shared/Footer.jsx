      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className='text-2xl text-[#6A38C2] font-serif font-extrabold'>Job<span className='text-[#040208]' >Mesh</span></h2>
            <p className="text-sm"> All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://www.instagram.com/prince_soni_2/" className="hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://x.com/home" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/prince-soni-a05027224/" className="hover:text-gray-400" aria-label="LinkedIn">
